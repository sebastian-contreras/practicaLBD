...
CREATE TABLE IF NOT EXISTS `Parcial2022`.`TitulosDelAutor` (
  `idTitulo` VARCHAR(6) NOT NULL,
  `idAutores` VARCHAR(11) NOT NULL,
  PRIMARY KEY (`idTitulo`, `idAutores`),
  INDEX `fk_Titulos_has_Autores_Autores1_idx` (`idAutores` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Titulos_has_Autores_Autores1`
    ...
    REFERENCES `Parcial2022`.`Autores` (`idAutores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
